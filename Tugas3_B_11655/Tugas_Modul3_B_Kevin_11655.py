...
if uploaded_file is not None:
    ...
    if os.path.exists(model_path):
        ...
        ing1 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.1", 64.0, 100.0)
        ing2 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.2", 62.0, 100.0)
        ing3 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.1", 68.0, 100.0)
        ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 68.0, 100.0)
        ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 67.0, 100.0)
        ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 70.0, 100.0)
        ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 65.0, 100.0)
        ind4 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.2", 70.0, 100.0)

        st.sidebar.subheader("Masukkan Nilai KKM")        
        kkm_ind1 = st.sidebar.number_input("Nilai KKM Bahasa Indonesia Semester 1.1", 0.0, 100.0)
        kkm_ind2 = st.sidebar.number_input("Nilai KKM Bahasa Indonesia Semester 1.2", 0.0, 100.0)
        kkm_ind3 = st.sidebar.number_input("Nilai KKM Bahasa Indonesia Semester 2.1", 0.0, 100.0)
        kkm_ind4 = st.sidebar.number_input("Nilai KKM Bahasa Indonesia Semester 2.2", 0.0, 100.0)
        kkm_ing1 = st.sidebar.number_input("Nilai KKM Bahasa Inggris Semester 1.1", 0.0, 100.0)
        kkm_ing2 = st.sidebar.number_input("Nilai KKM Bahasa Inggris Semester 1.2", 0.0, 100.0)
        kkm_ing3 = st.sidebar.number_input("Nilai KKM Bahasa Inggris Semester 2.1", 0.0, 100.0)
        kkm_ing4 = st.sidebar.number_input("Nilai KKM Bahasa InInggrisonesia Semester 2.2", 0.0, 100.0)
        kkm_mtk1 = st.sidebar.number_input("Nilai KKM Matematika Semester 1.1", 0.0, 100.0)
        kkm_mtk2 = st.sidebar.number_input("Nilai KKM Matematika Semester 1.2", 0.0, 100.0)
        kkm_mtk3 = st.sidebar.number_input("Nilai KKM Matematika Semester 2.1", 0.0, 100.0)
        kkm_mtk4 = st.sidebar.number_input("Nilai KKM Matematika Semester 2.2", 0.0, 100.0)


        input_data = [mtk1, mtk2, mtk3, mtk4, ing1, ing2, ing3, ing4, ind1, ind2, ind3, ind4,
                    kkm_mtk1, kkm_mtk2, kkm_mtk3, kkm_mtk4, kkm_ing1, kkm_ind2, kkm_ing3, kkm_ing4,
